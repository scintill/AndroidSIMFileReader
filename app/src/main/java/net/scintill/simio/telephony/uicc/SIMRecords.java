...
import net.scintill.simio.telephony.gsm.SimTlv;
...
public class SIMRecords extends IccRecords {
    ...
    private static final int EVENT_GET_LOCI_DONE = 35;
    ...
    public byte[] getTemporaryMobileSubscriberIdentity() {
        if (mLoci == null) return null;
        return Arrays.copyOfRange(mLoci, 0, 4);
    }

    public byte[] getLocationAreaInformation() {
        if (mLoci == null) return null;
        return Arrays.copyOfRange(mLoci, 4, 9);
    }
    ...
    public void handleMessage(Message msg) {
        ...
        try { switch (msg.what) {
            ...
            case EVENT_GET_LOCI_DONE:
                ...
                if (ar.exception != null) {
                    loge("Error loading LOCI");
                    break;
                }

                log("EF_LOCI: " + IccUtils.bytesToHexString(data));
                mLoci = data;
            break;
    ...
    protected void fetchSimRecords() {
        ...
        mFh.loadEFTransparent(EF_LOCI, obtainMessage(EVENT_GET_LOCI_DONE));
        mRecordsToLoad++;

        // comment out for AIMSICD
        /*
